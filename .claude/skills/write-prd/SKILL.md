...
## Dispatches
`product-manager` (lead). Pull evidence from `discovery-researcher`; success metrics from `product-analyst`;
...
4. Capture requirements/user stories with acceptance criteria; note UX flows and key states.
5. List dependencies, risks, assumptions, open questions; add a rollout & measurement plan.

## Methods
`knowledge/methods/requirements-and-stories.md`, `knowledge/methods/lean-product-process.md`,
`knowledge/methods/metrics-and-experimentation.md`.
